...
/* harmony default export */ var SelectsDoublevue_type_script_lang_js_ = ({
  ...
  methods: { ...mapActions(["updateCityData", "validationStatusTrue", "validationStatusFalse"]),
  ...
  computed: { ...mapGetters(["getUserData", "getNowItems", "getNowItemsFirstOptions", "getNowItemsSecondOptions"])
  },
  validations: {
    getUserData: {

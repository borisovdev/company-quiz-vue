...
## 0.4.6
### Added
- Возможность дополнять вопросы подсказкой, которая отображается в сайдбаре.
- Иконки для информации в сайдбаре
### Changed
- Дополнения к документации
- Классы стилей для информации в сайдбаре перенесены в elements.scss
